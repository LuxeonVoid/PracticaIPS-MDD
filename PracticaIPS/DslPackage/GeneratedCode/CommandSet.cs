...
namespace Company.PracticaIPS
{
	...
	/// </summary>
	internal partial class PracticaIPSCommandSet : PracticaIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new PracticaIPSCommandSet.
		/// </summary>
		public PracticaIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PracticaIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PracticaIPSCommandSetBase.
		/// </summary>
		protected PracticaIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPracticaIPSExplorerCommand,
				typeof(PracticaIPSEditorFactory).GUID);
		...
		{
			PracticaIPSExplorerToolWindow explorer = this.PracticaIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PracticaIPSDocData CurrentPracticaIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PracticaIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PracticaIPSDocView CurrentPracticaIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PracticaIPSDocView;
			}
		}
		...
		/// </summary>
		protected PracticaIPSExplorerToolWindow PracticaIPSExplorerToolWindow
		{
			get
			{
				PracticaIPSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PracticaIPSExplorerToolWindow), true) as PracticaIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PracticaIPSExplorerToolWindow explorerWindow = this.PracticaIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PracticaIPSClipboardCommandSet : PracticaIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PracticaIPSClipboardCommandSet.
		/// </summary>
		public PracticaIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PracticaIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PracticaIPSClipboardCommandSetBase.
		/// </summary>
		protected PracticaIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
