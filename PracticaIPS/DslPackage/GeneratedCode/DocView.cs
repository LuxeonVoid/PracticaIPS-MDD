...
namespace Company.PracticaIPS
{
	...
	/// </summary>
	internal partial class PracticaIPSDocView : PracticaIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new PracticaIPSDocView.
		/// </summary>
		public PracticaIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PracticaIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PracticaIPSDocView.
		/// </summary>
		protected PracticaIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PracticaIPSDocDataBase docData = this.DocData as PracticaIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PracticaIPSDocViewBase should be an PracticaIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.PracticaIPS.PracticaIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.PracticaIPS.PracticaIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.PracticaIPS.PracticaIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.PracticaIPS.PracticaIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PracticaIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.PracticaIPS.PracticaIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.PracticaIPS.PracticaIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.PracticaIPS.PracticaIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
