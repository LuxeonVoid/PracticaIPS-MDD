...
namespace Company.PracticaIPS
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.PracticaIPSEditorFactoryId)]
	internal partial class PracticaIPSEditorFactory : PracticaIPSEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new PracticaIPSEditorFactory.
		/// </summary>
		public PracticaIPSEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PracticaIPSEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected PracticaIPSEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new PracticaIPSDocData(this.ServiceProvider, typeof(PracticaIPSEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new PracticaIPSDocView(docData, this.ServiceProvider);
		}
	}
}
