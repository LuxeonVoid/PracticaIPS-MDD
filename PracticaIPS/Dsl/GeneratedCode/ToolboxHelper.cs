...
namespace Company.PracticaIPS
{
	...
	/// </remarks>
	public partial class PracticaIPSToolboxHelper : PracticaIPSToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new PracticaIPSToolboxHelper.
		/// </summary>
		public PracticaIPSToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class PracticaIPSToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify PracticaIPS toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "PracticaIPS.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new PracticaIPSToolboxHelperBase.
		/// </summary>
		protected PracticaIPSToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.PracticaIPS.PracticaIPSDomainModel.SingletonResourceManager.GetString("PracticaIPSToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.PracticaIPS.PracticaIPSDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.PracticaIPS.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.PracticaIPS.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.PracticaIPS.PracticaIPSToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("PracticaIPSToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.PracticaIPS.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.PracticaIPS.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.PracticaIPS.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.PracticaIPS.PracticaIPSDomainModel));
