...
namespace Company.PracticaIPS
{
	...
	/// </remarks>
	public partial class PracticaIPSHelpKeywordHelper : PracticaIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PracticaIPSHelpKeywordHelper.
		/// </summary>
		protected PracticaIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PracticaIPSHelpKeywordHelper.
		/// </summary>
		public static PracticaIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PracticaIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PracticaIPSHelpKeywordHelperBase.
		/// </summary>
		protected PracticaIPSHelpKeywordHelperBase()
			: base() { }
